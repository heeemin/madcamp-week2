...
import FlagBoard from '../../layouts/FlagBoard/FlagBoard'
import KeyBoard from '../../layouts/KeyBoard/KeyBoard'
...
const MazePage = ({ stage }) => {
  ...
  const [mazeBoardVerticalWall, setMazeBoardVerticalWall] = useState(
    jsonData.mazeBoardVerticalWall
  )
  const [mazeBoardHorizontalWall, setMazeBoardHorizontalWall] = useState(
    jsonData.mazeBoardHorizontalWall
  )
  ...
  const updateMazeBoardHorizontalWall = (row, col) => {
    const nextMazeBoardHorizontalWall = mazeBoardHorizontalWall.map(
      (rows, rowIndex) =>
        rows.map((cell, colIndex) =>
          rowIndex === row && colIndex === col ? 0 : cell
        )
  ...
  const getBackgroundColor = () => {
    switch (mazeColor) {
      case 0:
        return styles.bgColor0
      case 2:
        return styles.bgColor2
      case 3:
        return styles.bgColor3
      case 4:
        return styles.bgColor4
    }
  }
  ...
  const onDrag = useAnimatedGestureHandler({
    ...
    onEnd: (event, context) => {
      ...
      if (Math.abs(event.translationX) < Math.abs(event.translationY)) {
        if (event.translationY < 0) {
          if (screenFixed) {
            ...
            if (
              mazeBoardGrid[mazeBoardX + nextCharacterX][
                mazeBoardY + characterY
              ]
            ) {
              if (
                !mazeBoardHorizontalWall[mazeBoardX + characterX][
                  mazeBoardY + characterY
                ] &&
                !mazeBoardHorizontalWall[mazeBoardX + nextCharacterX + 1][
                  mazeBoardY + characterY
                ]
              ) {
                console.log(
            ...
            if (
              ...
              console.log(`nextMazeColor: 0`)
              runOnJS(setMazeColor)(0)
              runOnJS(updateMazeBoardHorizontalWall)(
                mazeBoardX + characterX,
                mazeBoardY + characterY
              )
        ...
        if (event.translationY > 0) {
          if (screenFixed) {
            ...
            if (
              ...
              if (
                !mazeBoardHorizontalWall[mazeBoardX + characterX + 1][
                  mazeBoardY + characterY
                ] &&
                !mazeBoardHorizontalWall[mazeBoardX + nextCharacterX][
                  mazeBoardY + characterY
                ]
              ) {
                console.log(
                ...
                runOnJS(setMazeColor)(0)
                runOnJS(updateMazeBoardHorizontalWall2)(
                  mazeBoardX + characterX + 1,
                  mazeBoardY + characterY,
                  mazeBoardX + nextCharacterX,
                  mazeBoardY + characterY
                )
      ...
      if (Math.abs(event.translationX) > Math.abs(event.translationY)) {
        if (event.translationX < 0) {
          if (screenFixed) {
            ...
            if (
              mazeBoardGrid[mazeBoardX + characterX][
                mazeBoardY + nextCharacterY
              ]
            ) {
              if (
                !mazeBoardVerticalWall[mazeBoardX + characterX][
                  mazeBoardY + characterY
                ] &&
                !mazeBoardVerticalWall[mazeBoardX + characterX][
                  mazeBoardY + nextCharacterY + 1
            ...
            if (
              ...
              console.log(`nextMazeColor: 0`)
              runOnJS(setMazeColor)(0)
              runOnJS(updateMazeBoardVerticalWall)(
                mazeBoardX + characterX,
                mazeBoardY + characterY
              )
      ...
      if (mazeKeyGrid[mazeBoardX + characterX][mazeBoardY + characterY]) {
        console.log(
          `nextMazeColor: ${
            mazeKeyGrid[mazeBoardX + characterX][mazeBoardY + characterY]
          }`
        )
        runOnJS(setMazeColor)(
          mazeKeyGrid[mazeBoardX + characterX][mazeBoardY + characterY]
        )

        runOnJS(updateMazeKeyGrid)(
          mazeBoardX + characterX,
          mazeBoardY + characterY
        )
      }
  ...
  return (
    <GestureHandlerRootView
      style={[styles.container, runOnJS(getBackgroundColor)()]}
    >
      <PanGestureHandler onGestureEvent={onDrag}>
        <AnimatedView style={[styles.container, runOnJS(getBackgroundColor)()]}>
          <TapGestureHandler onGestureEvent={onDoubleTap} numberOfTaps={2}>
            <AnimatedView
              style={[styles.container, runOnJS(getBackgroundColor)()]}
            >
